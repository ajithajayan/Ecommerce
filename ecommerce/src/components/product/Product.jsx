            ...
            {productData && (
                <>
                    <Link to={`/product/${productData.id}`}>
                        <div className='imgWrapper'>
                            <div className='p-4 wrapper mb-3'>
                                <img src={productData.catImg + '?im=Resize=(420,420)'} className='w-100' alt={productData.productName} />
                            </div>
                    ...
                    <div className='info'>
                        ...
                        <h4 className='title'>
                            <Link to={`/product/${productData.id}`}>
                                {productData.productName ? productData.productName.substr(0, 50) + '...' : ''}
                            </Link>
                        </h4>
                        <Rating
                        ...
                        <span className='brand d-block text-g'>
                            By <Link to={`/brand/${productData.brandId}`} className='text-g'>{productData.brand}</Link>
                        </span>
